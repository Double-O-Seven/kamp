...
internal class PlayerTextDrawImplTest {
    ...
    inner class ConstructorTests {
        ...
        fun shouldConstructPlayerTextDraw() {
            ...
            val playerTextDraw = PlayerTextDrawImpl(
                    text = "test",
    ...
    inner class PostConstructionTests {
        ...
        private lateinit var playerTextDraw: PlayerTextDrawImpl
        ...
        fun setUp() {
            ...
            playerTextDraw = PlayerTextDrawImpl(
                    text = "test",
        ...
        fun shouldExecuteOnSpawnHandlers() {
            val onClick = mockk<PlayerTextDraw.() -> Boolean>(relaxed = true)
        ...
        inner class DestroyTests {
            ...
            fun shouldDestroyPlayerTextDraw() {
                val onDestroy = mockk<PlayerTextDrawImpl.() -> Unit>(relaxed = true)
