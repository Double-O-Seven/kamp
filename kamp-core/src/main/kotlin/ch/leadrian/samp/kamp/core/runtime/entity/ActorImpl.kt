...
internal class ActorImpl(
        model: ch.leadrian.samp.kamp.core.api.constants.SkinModel,
    ...
    override fun applyAnimation(animation: ch.leadrian.samp.kamp.core.api.data.Animation, fDelta: Float, loop: Boolean, lockX: Boolean, lockY: Boolean, freeze: Boolean, time: Int) {
