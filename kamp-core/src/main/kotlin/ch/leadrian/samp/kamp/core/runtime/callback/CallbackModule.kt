...
internal class CallbackModule : KampModule() {
    ...
    override fun configure() {
        ...
        bind(OnMapObjectMovedHandler::class.java)
        ...
        bind(OnPlayerCancelTextDrawSelectionHandler::class.java)
        ...
        bind(OnPlayerMapObjectMovedHandler::class.java)
        ...
        newCallbackListenerRegistrySetBinder().apply {
            ...
            addBinding().to(OnMapObjectMovedHandler::class.java)
            ...
            addBinding().to(OnPlayerCancelTextDrawSelectionHandler::class.java)
            ...
            addBinding().to(OnPlayerMapObjectMovedHandler::class.java)
