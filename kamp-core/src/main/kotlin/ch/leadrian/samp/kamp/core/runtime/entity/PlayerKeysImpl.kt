...
internal class PlayerKeysImpl(
    ...
    override fun isKeyPressed(vararg keys: ch.leadrian.samp.kamp.core.api.constants.PlayerKey): Boolean =
            keys.all { this.keys and it.value != 0 }

    override fun isOnlyKeyPressed(vararg keys: ch.leadrian.samp.kamp.core.api.constants.PlayerKey): Boolean =
