...
internal constructor(
    ...
    private constructor(
            ...
            maxZ: Float,
            isMainZone: Boolean
    ) : this(name, textKey, boxOf(minX = minX, maxX = maxX, minY = minY, maxY = maxY, minZ = minZ, maxZ = maxZ), isMainZone)
    ...
    companion object {
        ...
        val allZones: List<SanAndreasZone> = unmodifiableList(listOf(
                SanAndreasZone(
