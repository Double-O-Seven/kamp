...
internal class PlayerMapObjectImpl(
    ...
    private val onEditHandlers: MutableList<PlayerMapObject.(ch.leadrian.samp.kamp.core.api.constants.ObjectEditResponse, Vector3D, Vector3D) -> Unit> =
            mutableListOf()
    ...
    override fun onEdit(onEdit: PlayerMapObject.(ch.leadrian.samp.kamp.core.api.constants.ObjectEditResponse, Vector3D, Vector3D) -> Unit) {
        onEditHandlers += onEdit
    }

    internal fun onEdit(response: ch.leadrian.samp.kamp.core.api.constants.ObjectEditResponse, offset: Vector3D, rotation: Vector3D) {
