...
import ch.leadrian.samp.kamp.core.api.entity.requireOnline
...
internal class PlayerImpl(
    ...
    private val onDeathHandlers: MutableList<Player.(Player?, ch.leadrian.samp.kamp.core.api.constants.WeaponModel) -> Unit> = mutableListOf()

    private val onDisconnectHandlers: MutableList<PlayerImpl.(ch.leadrian.samp.kamp.core.api.constants.DisconnectReason) -> Unit> = mutableListOf()
    ...
    override fun setAmmo(weaponModel: ch.leadrian.samp.kamp.core.api.constants.WeaponModel, ammo: Int) {
    ...
    override val weaponState: ch.leadrian.samp.kamp.core.api.constants.WeaponState
        get() = nativeFunctionExecutor.getPlayerWeaponState(id.value).let { ch.leadrian.samp.kamp.core.api.constants.WeaponState[it] }
    ...
    override var skin: ch.leadrian.samp.kamp.core.api.constants.SkinModel
        get() = nativeFunctionExecutor.getPlayerSkin(id.value).let { ch.leadrian.samp.kamp.core.api.constants.SkinModel[it] }
        set(value) {
            nativeFunctionExecutor.setPlayerSkin(playerid = id.value, skinid = value.value)
        }

    override var armedWeapon: ch.leadrian.samp.kamp.core.api.constants.WeaponModel
        get() = nativeFunctionExecutor.getPlayerWeapon(id.value).let { ch.leadrian.samp.kamp.core.api.constants.WeaponModel[it] }
        set(value) {
            nativeFunctionExecutor.setPlayerArmedWeapon(playerid = id.value, weaponid = value.value)
        }

    override fun getWeaponData(slot: ch.leadrian.samp.kamp.core.api.constants.WeaponSlot): WeaponData {
        ...
        return weaponDataOf(model = ch.leadrian.samp.kamp.core.api.constants.WeaponModel[weapon.value], ammo = ammo.value)
    }
    ...
    override val state: ch.leadrian.samp.kamp.core.api.constants.PlayerState
        get() = nativeFunctionExecutor.getPlayerState(id.value).let { ch.leadrian.samp.kamp.core.api.constants.PlayerState[it] }
    ...
    override fun setWeather(weather: ch.leadrian.samp.kamp.core.api.constants.Weather) {
    ...
    override var fightingStyle: ch.leadrian.samp.kamp.core.api.constants.FightingStyle
        get() = nativeFunctionExecutor.getPlayerFightingStyle(id.value).let { ch.leadrian.samp.kamp.core.api.constants.FightingStyle[it] }
        set(value) {
            nativeFunctionExecutor.setPlayerFightingStyle(playerid = id.value, style = value.value)
        }

    override fun playCrimeReport(suspect: Player, crimeReport: ch.leadrian.samp.kamp.core.api.constants.CrimeReport) {
    ...
    override fun setShopName(shopName: ch.leadrian.samp.kamp.core.api.constants.ShopName) {
        nativeFunctionExecutor.setPlayerShopName(playerid = id.value, shopname = shopName.value)
    }

    override fun setSkillLevel(skill: ch.leadrian.samp.kamp.core.api.constants.WeaponSkill, level: Int) {
    ...
    override fun setChatBubble(text: String, color: ch.leadrian.samp.kamp.core.api.data.Color, drawDistance: Float, expireTime: Int) {
    ...
    override fun applyAnimation(animation: ch.leadrian.samp.kamp.core.api.data.Animation, fDelta: Float, loop: Boolean, lockX: Boolean, lockY: Boolean, freeze: Boolean, time: Int, forceSync: Boolean) {
    ...
    override var specialAction: ch.leadrian.samp.kamp.core.api.constants.SpecialAction
        get() = nativeFunctionExecutor.getPlayerSpecialAction(id.value).let { ch.leadrian.samp.kamp.core.api.constants.SpecialAction[it] }
        set(value) {
    ...
    override fun showPlayerMarker(player: Player, color: ch.leadrian.samp.kamp.core.api.data.Color) {
    ...
    override fun createMapIcon(playerMapIconId: PlayerMapIconId, coordinates: Vector3D, type: ch.leadrian.samp.kamp.core.api.constants.MapIconType, color: ch.leadrian.samp.kamp.core.api.data.Color, style: ch.leadrian.samp.kamp.core.api.constants.MapIconStyle): PlayerMapIcon {
        requireOnline()
    ...
    override fun setCameraLookAt(coordinates: Vector3D, type: ch.leadrian.samp.kamp.core.api.constants.CameraType) {
    ...
    override val cameraMode: ch.leadrian.samp.kamp.core.api.constants.CameraMode
        get() = nativeFunctionExecutor.getPlayerCameraMode(id.value).let { ch.leadrian.samp.kamp.core.api.constants.CameraMode[it] }
    ...
    override fun interpolateCameraPosition(from: Vector3D, to: Vector3D, time: Int, type: ch.leadrian.samp.kamp.core.api.constants.CameraType) {
    ...
    override fun interpolateCameraLookAt(from: Vector3D, to: Vector3D, time: Int, type: ch.leadrian.samp.kamp.core.api.constants.CameraType) {
    ...
    override fun spectate(player: Player, mode: ch.leadrian.samp.kamp.core.api.constants.SpectateType) {
        if (!isSpectating) {
    ...
    override fun spectate(vehicle: Vehicle, mode: ch.leadrian.samp.kamp.core.api.constants.SpectateType) {
        if (!isSpectating) {
            toggleSpectating(true)
        }
    ...
    override fun startRecording(type: ch.leadrian.samp.kamp.core.api.constants.PlayerRecordingType, recordName: String) {
    ...
    override fun createExplosion(type: ch.leadrian.samp.kamp.core.api.constants.ExplosionType, area: Sphere) {
    ...
    override fun createExplosion(type: ch.leadrian.samp.kamp.core.api.constants.ExplosionType, coordinates: Vector3D, radius: Float) {
        nativeFunctionExecutor.createExplosionForPlayer(
                playerid = id.value,
                X = coordinates.x,
                Y = coordinates.y,
    ...
    override fun selectTextDraw(hoverColor: ch.leadrian.samp.kamp.core.api.data.Color) {
    ...
    override fun onDeath(onDeath: Player.(Player?, ch.leadrian.samp.kamp.core.api.constants.WeaponModel) -> Unit) {
        onDeathHandlers += onDeath
    }

    internal fun onDeath(killer: Player?, weapon: ch.leadrian.samp.kamp.core.api.constants.WeaponModel) {
        onDeathHandlers.forEach { it.invoke(this, killer, weapon) }
    }

    internal fun onDisconnect(onDisconnect: PlayerImpl.(ch.leadrian.samp.kamp.core.api.constants.DisconnectReason) -> Unit) {
    ...
    internal fun onDisconnect(reason: ch.leadrian.samp.kamp.core.api.constants.DisconnectReason) {
