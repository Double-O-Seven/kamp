...
internal class VehicleAngledLocationPropertyTest {
    ...
    private lateinit var vehicleAngledLocationProperty: VehicleAngledLocationProperty

    @BeforeEach
    fun setUp() {
        every { vehicle.id } returns vehicleId
        vehicleAngledLocationProperty = VehicleAngledLocationProperty(nativeFunctionExecutor)
    }
    ...
    fun shouldGetAngledLocation() {
        ...
        val angledLocation = vehicleAngledLocationProperty.getValue(vehicle, property)
    ...
    fun shouldSetAngledLocation() {
        ...
        vehicleAngledLocationProperty.setValue(
                vehicle,
                property,
