...
internal class CachingPlayerNamePropertyTest {
    ...
    private lateinit var cachingPlayerNameProperty: PlayerNameProperty

    @BeforeEach
    fun setUp() {
        every { player.id } returns playerId
        cachingPlayerNameProperty = CachingPlayerNameProperty(nativeFunctionExecutor, onPlayerNameChangeHandler)
    ...
    fun givenWasNotYetSetItShouldGetPlayerName() {
        ...
        val name = cachingPlayerNameProperty.getValue(player, property)
    ...
    fun givenNameWasSetItShouldReturnCachedName() {
        ...
        cachingPlayerNameProperty.setValue(player, property, "hans.wurst")
    ...
    fun shouldCallOnPlayerNameChangeHandler() {
        ...
        cachingPlayerNameProperty.setValue(player, property, "John.Sausage")
    ...
    fun givenEmptyNameIsSetItShouldThrowAnException() {
        val caughtThrowable = catchThrowable { cachingPlayerNameProperty.setValue(player, property, "") }
