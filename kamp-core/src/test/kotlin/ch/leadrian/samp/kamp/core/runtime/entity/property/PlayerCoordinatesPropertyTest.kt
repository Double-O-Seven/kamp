...
internal class PlayerCoordinatesPropertyTest {
    ...
    private lateinit var playerCoordinatesProperty: PlayerCoordinatesProperty

    @BeforeEach
    fun setUp() {
        every { player.id } returns playerId
        playerCoordinatesProperty = PlayerCoordinatesProperty(nativeFunctionExecutor)
    }
    ...
    fun shouldGetCoordinates() {
        ...
        val coordinates = playerCoordinatesProperty.getValue(player, property)
    ...
    fun shouldSetCoordinates() {
        ...
        playerCoordinatesProperty.setValue(player, property, vector3DOf(x = 1f, y = 2f, z = 3f))
