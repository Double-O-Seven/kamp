...
internal class PlayerLastShotVectorsPropertyTest {
    ...
    private lateinit var playerLastShotVectorsProperty: PlayerLastShotVectorsProperty

    @BeforeEach
    fun setUp() {
        every { player.id } returns playerId
        playerLastShotVectorsProperty = PlayerLastShotVectorsProperty(nativeFunctionExecutor)
    }
    ...
    fun shouldLastShotVectors() {
        ...
        val lastShotVectors = playerLastShotVectorsProperty.getValue(player, property)
