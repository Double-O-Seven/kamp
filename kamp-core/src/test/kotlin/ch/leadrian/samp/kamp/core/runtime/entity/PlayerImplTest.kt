...
internal class PlayerImplTest {
    ...
    inner class OnDisconnectTests {
        ...
        fun shouldExecuteOnDisconnectHandlers() {
            val onDisconnect = mockk<PlayerImpl.(ch.leadrian.samp.kamp.core.api.constants.DisconnectReason) -> Unit>(relaxed = true)
            player.onDisconnect(onDisconnect)

            player.onDisconnect(ch.leadrian.samp.kamp.core.api.constants.DisconnectReason.QUIT)

            verify { onDisconnect.invoke(player, ch.leadrian.samp.kamp.core.api.constants.DisconnectReason.QUIT) }
        }
        ...
        fun shouldNotExecuteTwice() {
            ...
            verify(exactly = 1) {
                onDisconnect.invoke(player, ch.leadrian.samp.kamp.core.api.constants.DisconnectReason.QUIT)
            }
        }
