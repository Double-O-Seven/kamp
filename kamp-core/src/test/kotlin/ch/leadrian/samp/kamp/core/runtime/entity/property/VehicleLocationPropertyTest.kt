...
internal class VehicleLocationPropertyTest {
    ...
    private lateinit var vehicleLocationProperty: VehicleLocationProperty

    @BeforeEach
    fun setUp() {
        every { vehicle.id } returns vehicleId
        vehicleLocationProperty = VehicleLocationProperty(nativeFunctionExecutor)
    }
    ...
    fun shouldGetLocation() {
        ...
        val location = vehicleLocationProperty.getValue(vehicle, property)
    ...
    fun shouldSetLocation() {
        ...
        vehicleLocationProperty.setValue(
                vehicle,
                property,
