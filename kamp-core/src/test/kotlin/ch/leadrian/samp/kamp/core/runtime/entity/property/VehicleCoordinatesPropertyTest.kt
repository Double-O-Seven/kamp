...
internal class VehicleCoordinatesPropertyTest {
    ...
    private lateinit var vehicleCoordinatesProperty: VehicleCoordinatesProperty

    @BeforeEach
    fun setUp() {
        every { vehicle.id } returns vehicleId
        vehicleCoordinatesProperty = VehicleCoordinatesProperty(nativeFunctionExecutor)
    }
    ...
    fun shouldGetCoordinates() {
        ...
        val coordinates = vehicleCoordinatesProperty.getValue(vehicle, property)
    ...
    fun shouldSetCoordinates() {
        ...
        vehicleCoordinatesProperty.setValue(vehicle, property, vector3DOf(x = 1f, y = 2f, z = 3f))
