...
internal class TextDrawImplTest {
    ...
    inner class PostConstructionTests {
        ...
        private lateinit var textDraw: TextDrawImpl
        ...
        inner class AlignmentTests {
            ...
            fun shouldSetAlignment() {
                ...
                textDraw.alignment = ch.leadrian.samp.kamp.core.api.constants.TextDrawAlignment.CENTERED
        ...
        inner class FontTests {
            ...
            fun shouldSetFont() {
                ...
                textDraw.font = ch.leadrian.samp.kamp.core.api.constants.TextDrawFont.BANK_GOTHIC
        ...
        inner class PreviewModelTests {
            ...
            fun shouldInitializePreviewModel() {
                val previewModel = textDraw.previewModel
        ...
        inner class DestroyTests {
            ...
            fun shouldDestroyTextDraw() {
                val onDestroy = mockk<TextDrawImpl.() -> Unit>(relaxed = true)
