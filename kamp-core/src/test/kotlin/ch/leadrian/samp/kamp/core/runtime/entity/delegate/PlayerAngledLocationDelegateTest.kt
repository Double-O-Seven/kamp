...
internal class PlayerAngledLocationDelegateTest {
    ...
    private lateinit var playerAngledLocationDelegate: PlayerAngledLocationDelegate

    @BeforeEach
    fun setUp() {
        every { player.id } returns playerId
        playerAngledLocationDelegate = PlayerAngledLocationDelegate(nativeFunctionExecutor)
    }
    ...
    fun shouldGetAngledLocation() {
        ...
        val angledLocation = playerAngledLocationDelegate.getValue(player, property)
    ...
    fun shouldSetAngledLocation() {
        ...
        playerAngledLocationDelegate.setValue(
                player,
                property,
