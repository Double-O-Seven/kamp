...
internal class PlayerNameDelegateTest {
    ...
    private lateinit var playerNameDelegate: PlayerNameDelegate

    @BeforeEach
    fun setUp() {
        every { player.id } returns playerId
        playerNameDelegate = PlayerNameDelegate(nativeFunctionExecutor, onPlayerNameChangeHandler)
    ...
    fun givenWasNotYetSetItShouldGetPlayerName() {
        ...
        val name = playerNameDelegate.getValue(player, property)
    ...
    fun givenResultingNameIsNullItShouldThrowException() {
        ...
        val caughtThrowable = catchThrowable { playerNameDelegate.getValue(player, property) }
    ...
    fun givenNameWasSetItShouldReturnCachedName() {
        ...
        playerNameDelegate.setValue(player, property, "hans.wurst")
    ...
    fun shouldCallOnPlayerNameChangeHandler() {
        ...
        playerNameDelegate.setValue(player, property, "John.Sausage")
    ...
    fun givenEmptyNameIsSetItShouldThrowAnException() {
        val caughtThrowable = catchThrowable { playerNameDelegate.setValue(player, property, "") }
