...
internal class VehicleTrailerTest {

    private lateinit var vehicleTrailer: VehicleTrailer
    ...
    fun shouldAttachTrailerToVehicle() {
        ...
        verify {
            nativeFunctionExecutor.attachTrailerToVehicle(
                    trailerid = trailerVehicleId.value,
