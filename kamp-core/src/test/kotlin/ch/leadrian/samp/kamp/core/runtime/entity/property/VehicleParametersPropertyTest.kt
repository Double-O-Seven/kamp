...
internal class VehicleParametersPropertyTest {
    ...
    private lateinit var vehicleParametersProperty: VehicleParametersProperty

    @BeforeEach
    fun setUp() {
        every { vehicle.id } returns vehicleId
        vehicleParametersProperty = VehicleParametersProperty(nativeFunctionExecutor)
    }
    ...
    fun shouldGetParameters(
        ...
        val parameters = vehicleParametersProperty.getValue(vehicle, property)
    ...
    fun shouldSetParameters(
        ...
        vehicleParametersProperty.setValue(
                vehicle,
                property,
                vehicleParametersOf(
                        engine = engine,
