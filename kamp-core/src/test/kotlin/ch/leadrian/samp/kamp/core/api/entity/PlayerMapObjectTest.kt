...
internal class PlayerMapObjectTest {
    ...
    inner class PostConstructionTests {
        ...
        fun shouldEdit() {
            ...
            verify {
                nativeFunctionExecutor
                        .editPlayerObject(playerid = playerId.value, objectid = playerMapObjectId.value)
            }
        }
        ...
        fun shouldAttachToPlayer() {
            every {
                nativeFunctionExecutor
                        .attachPlayerObjectToPlayer(any(), any(), any(), any(), any(), any(), any(), any(), any())
            } returns true
        ...
        fun shouldAttachToVehicle() {
            every {
                nativeFunctionExecutor
                        .attachPlayerObjectToVehicle(any(), any(), any(), any(), any(), any(), any(), any(), any())
            } returns true
        ...
        fun shouldCallOnPlayerEditPlayerMapObjectReceiverDelegate() {
            every {
                onPlayerEditPlayerMapObjectReceiver
                        .onPlayerEditPlayerMapObject(any(), any(), any(), any())
            } just Runs
