...
interface OnPlayerLeaveStreamableRaceCheckpoint {

    @InlineCallback("onLeave")
    fun onPlayerLeaveStreamableRaceCheckpoint(player: Player, @Receiver streamableRaceCheckpoint: StreamableRaceCheckpoint)
