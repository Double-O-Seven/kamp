...
interface OnStreamableRaceCheckpointStreamOutListener {

    @InlineCallback("onStreamOut")
    fun onStreamableRaceCheckpointStreamOut(@Receiver streamableRaceCheckpoint: StreamableRaceCheckpoint, forPlayer: Player)
