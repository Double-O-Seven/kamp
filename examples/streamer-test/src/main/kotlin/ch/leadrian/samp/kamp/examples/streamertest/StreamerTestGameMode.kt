...
class StreamerTestGameMode : GameMode(), OnGameModeInitListener {
    ...
    override fun onGameModeInit() {
        serverService.setGameModeText("Kamp Streamer Test")
        playerService.apply {
    ...
    override fun getModules(): List<Module> = listOf(StreamerTestModule())
