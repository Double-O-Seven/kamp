...
internal class SAMPNativeFunctionsCppGenerator(
    ...
    private fun Writer.writeFunctionBody(function: Function) {
        ...
        val resultProcessingSteps = methodParameterGenerators.asReversed().mapNotNull { it.generateMethodCallResultProcessing() }
        ...
        write("${function.name}(")
        write(methodParameterGenerators.joinToString(separator = ", ") { it.generateJniMethodCallParameter() })
        write(");\n")
