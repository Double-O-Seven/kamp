...
internal class SAMPCallbacksCppGenerator(
    ...
    private fun Writer.writeJniMethodCallSetup(function: Function, methodParameterGenerators: List<MethodParameterGenerator>) {
    ...
    private fun Writer.writeJniMethodCall(function: Function, methodParameterGenerators: List<MethodParameterGenerator>) {
        when {
    ...
    private fun Writer.writeMethodCallResultProcessing(function: Function, methodParameterGenerators: List<MethodParameterGenerator>) {
        write("    HandleException(jniEnv);\n")

        val resultProcessingSteps = methodParameterGenerators.mapNotNull { it.generateMethodCallResultProcessing() }.reversed()
